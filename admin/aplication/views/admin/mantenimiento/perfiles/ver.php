				...
				<div id="toolbar-box">
            		...
            		<div class="m">
	                    ...
	                    <? $BarraMenuIcon->CrearMenuIcon();?>
							<? $BarraMenuIcon->CrearBoton('Nuevo','new','ING_PERFIL');?>
                            <? $BarraMenuIcon->CrearBoton('Editar','edit','EDIT_PERFIL');?>
                            <? $BarraMenuIcon->CrearBoton('Borrar','delete','ELI_PERFIL');?>
                            <? $BarraMenuIcon->CrearBoton('Cancelar','cancel','VER_PERFIL');?>
